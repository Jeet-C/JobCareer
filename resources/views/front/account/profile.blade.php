                ...
                <div class="card border-0 shadow mb-4">
                    <form id="userForm" >
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name"  placeholder="Enter Name" class="form-control" value="{{ $user_data->name }}">
                             <p></p>
                        </div>
                       
                        <div class="mb-4">
                            <label for="email" class="mb-2">Email*</label>
                            <input type="text" name="email" id="email" placeholder="Enter Email" class="form-control" value="{{ $user_data->email }}" readonly>
                        </div>
                        <div class="mb-4">
                            <label for="Designation" class="mb-2">Designation*</label>
                            <input type="text" name="Designation" id="Designation" placeholder="Designation" class="form-control" value="{{ $user_data->designation }}">
                          <p></p>
                        </div>
                        <div class="mb-4">
                            <label for="mobile" class="mb-2">Mobile</label>
                            <input type="text" name="mobile" id="mobile" placeholder="Mobile" class="form-control" value="{{ $user_data->mobile }}">
                        </div>                        
                    </div>
